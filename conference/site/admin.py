...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('usertitle', 'last_name', 'first_name', 'email', 'affiliation', 'address', 'city', 'postal_code', 'country', 'speaker', 'student', 'postconf', 'vegeterian', 'arrival', 'departure', 'accompanying', 'tshirt', 'payment', 'remark', letter_tex, letter_pdf, certificate_tex, certificate_pdf)
