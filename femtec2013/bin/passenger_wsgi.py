...
def setup_femtec_retail():
    sys.path.insert(0, os.getcwd())
    os.environ['DJANGO_SETTINGS_MODULE'] = "femtec.settings"
    import django.core.handlers.wsgi
    return django.core.handlers.wsgi.WSGIHandler()

def setup_femtec_debug():
...
def setup_femtec(debug=False):
    if not debug:
        return setup_femtec_retail()
    else:
        return setup_femtec_debug()

application = setup_femtec()
