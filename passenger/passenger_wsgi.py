...
def setup_conference(debug=False):
    if not debug:
        return setup_conference_retail()
    else:
        return setup_conference_debug()

application = setup_conference()
